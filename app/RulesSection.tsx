      ...
      <div className="w-full max-w-2xl lg:max-w-none h-full p-3 lg:p-6 flex flex-col">
        <div className="flex-1 rounded-xl border border-neutral-200 bg-white text-neutral-900 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 flex flex-col min-h-0">
          <button 
            ...
            className="cursor-pointer flex items-center justify-between w-full text-base lg:text-lg font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-black transition-colors flex-shrink-0 p-4 lg:p-6"
          >
            <span>
              Toon regels{' '}
            ...
            <svg
              className={`w-5 h-5 transition-transform duration-200 ${isRulesOpen ? 'rotate-0' : 'rotate-180'}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
